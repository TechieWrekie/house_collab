...
export default function UserLogin() {
  ...
  const formHandle = (e) => {
    ...
    ApiServices.login(data)
      .then((res) => {
        if (res.data.success && res.data.data.userType === 2) {
          setload(true);
        }
        ...
        if (res.data.success) {
          ...
          if (res.data.data.userType === 1 || res.data.data.userType === 3) {
            ...
            setTimeout(() => {
              ...
              sessionStorage.setItem("_id", JSON.stringify(res.data.data._id));
              history('/user');
                    ...
                    <div className="col-lg-6">
                      <div className="card-body  mx-4 ">
                        ...
                        <div className="text-center">
                          ...
                          <h4 className="mt-1 mb-5 pb-1">Welcome to User Login Page</h4>
                        </div>
                          ...
                          <div className='row'>
                            <div className='col-md-12'>
                              <div className="d-flex align-items-center justify-content-center pb-4">
                                ...
                                <Link to="/user/registration" type="button" className="btn btn-outline-danger">Create new</Link>
                              </div>
                            </div>
                            <div className='col-md-12'>
                              <div className="d-flex align-items-center justify-content-center pb-4">
